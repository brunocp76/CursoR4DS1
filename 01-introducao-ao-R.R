...
# 1. Escreva um código que crie um objeto chamado "maior_ou_igual_a_10" com
# apenas os valores maiores ou iguais a 10 do vetor abaixo:

vetor <- c(4, 8, 15, 16, 23, 42)
vetor >= 10

maior_ou_igual_a_10 <- vetor[vetor >= 10]
maior_ou_igual_a_10
...
install.packages(c("remotes", "rmarkdown", "knitr","skimr",
                   ...
                   "DBI", "RSQLite", "jsonlite"), dependencies = TRUE)
